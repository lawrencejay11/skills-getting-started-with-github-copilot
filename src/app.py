...
activities = {
    ...
    "Basketball Club": {
        "description": "Develop shooting, dribbling, and game strategy skills on the court",
        "schedule": "Tuesdays and Thursdays, 4:00 PM - 5:30 PM",
        "max_participants": 15,
        "participants": ["nathan@mergington.edu", "zoe@mergington.edu"]
    },
    "Art Club": {
        "description": "Explore painting, drawing, and mixed media techniques in a creative space",
        "schedule": "Mondays, 3:30 PM - 5:00 PM",
        "max_participants": 15,
        "participants": ["ava@mergington.edu", "isabella@mergington.edu"]
    },
    "Drama Society": {
        "description": "Practice acting, stage presence, and performance skills in theatrical productions",
    ...
    "Debate Team": {
        "description": "Research current issues, craft arguments, and compete in formal debates",
